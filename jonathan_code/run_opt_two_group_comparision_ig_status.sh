...
Rscript /projects/blueprint_CLL_dart2/jsteif/scripts/opt_two_group_comparision_ig_status.R -t $sample_type1 -T $sample_type2 -i $input_tables_directory -o $out_directory -c $chromosome -p $p_value_threshold -m $mark 
